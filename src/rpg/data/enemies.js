export default {
    creatures: {
        ...
        badger:   { emoji: '🦡', literal: 'a :adj badger',   dmg: 0,  hp: 20, xp: 25 },
        bear:     { emoji: '🐻', literal: 'a :adj bear',     dmg: 0,  hp: 30 },
        bees:     { emoji: '🐝', literal: ':adj bees',       dmg: 0,  hp: -40, hits: 5, xp: 50 },
        boar:     { emoji: '🐗', literal: 'a :adj boar',     dmg: 0,  hp: 0, speed: 0.5 },
        child:    { emoji: '👦', literal: 'a :adj child',    dmg: 0,  hp: -30, xp: -100 },
        crab:     { emoji: '🦀', literal: '2 :adj crabs',    dmg: 0,  hp: 0, hits: 2, xp: 50 },
        devil:    { emoji: '😈', literal: 'the :adj devil',  dmg: 5,  hp: 40, xp: 100 },
        doctor:   { emoji: '👩‍⚕️', literal: 'a :adj doctor',   dmg: 0,  hp: 0 },
        dragon:   { emoji: '🐉', literal: 'a :adj dragon',   dmg: 10, hp: 0, xp: 100 },
        fly:      { emoji: '🪰',  literal: 'a :adj fly',      dmg: 0,  hp: -50, evasive: true },
        frogs:    { emoji: '🐸', literal: ':adj frogs',      dmg: 0,  hp: 0, hits: 3, xp: 50 },
        ...
        gorilla:  { emoji: '🦍', literal: 'a :adj gorilla',  dmg: 5,  hp: 10 },
        gun:      { emoji: '🔫', literal: 'a :adj gun',      dmg: 20, hp: -20, xp: 100 },
        lion:     { emoji: '🦁', literal: 'a :adj lion',     dmg: 5,  hp: 0, xp: 50 },
        magician: { emoji: '🕴🏻',  literal: 'a :adj magician', dmg: 0,  hp: 30, xp: 50, tricky: true },
        monke:    { emoji: '🦧', literal: 'le :adj monke',   dmg: 0,  hp: 0 },
        monkey:   { emoji: '🐵', literal: 'a :adj monkey',   dmg: 0,  hp: -10, speed: 0.5 },
        ogre:     { emoji: '👹', literal: 'a :adj ogre',     dmg: 20,  hp: 20, speed: -2, slow: true, xp: 50 },
        penguin:  { emoji: '🐧', literal: 'a :adj penguin',  dmg: 0,  hp: 0, speed: -1 },
        pumpkin:  { emoji: '🎃', literal: 'a :adj pumpkin',  dmg: 5,  hp: -10, xp: -10 },
        robot:    { emoji: '🤖', literal: 'a :adj robot',    dmg: 0,  hp: 20, xp: 25 },
        scorpion: { emoji: '🦂', literal: 'a :adj scorpion', dmg: 0,  hp: 0 },
        shadow:   { emoji: '👤', literal: 'a :adj shadow',   dmg: 0,  hp: -10, xp: 100, shadowy: true },
        ...
        tiger:    { emoji: '🐯', literal: 'a :adj tiger',    dmg: 0,  hp: 0, speed: 0.5, xp: 50 },
        trex:     { emoji: '🦖', literal: 'a :adj t-rex',    dmg: 5,  hp: 30 },
        turtle:   { emoji: '🐢', literal: 'a :adj turtle',   dmg: 0,  hp: -50, shield: 75, xp: 25, speed: -0.5 },
        unicorn:  { emoji: '🦄', literal: 'a :adj unicorn',  dmg: 5, hp: 50, award: 50, speed: 0.5, xp: 400 },
        vampire:  { emoji: '🧛', literal: 'a :adj vampire',  dmg: 0,  hp: 0, lifesteal: 15 },
        wizard:   { emoji: '🧙‍♂️', literal: 'a :adj wizard',   dmg: 0,  hp: 0 },
        wolf:     { emoji: '🐺', literal: 'a :adj wolf',     dmg: 0,  hp: 0, speed: 0.5 },
